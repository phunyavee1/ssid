...
def configure_ssid1():
    ...
    config_commands = [
        ...
        f'wlan {ssid1} policy Flexconnect-policy',
        f'end',
    ]
...
def configure_ssid():
    ...
    config_commands = [
        ...
        f'wlan {ssid} policy Flexconnect-policy',
        f'end',
    ]
...
def configure_ssid2():
    ...
    config_commands = [
        ...
        f'wlan {ssid2} policy Flexconnect-policy',
        f'end',
    ]
...
def post(ssid2, event2, location2):
...
def delete_ssid(ssid_id):
    ...
    config_commands = [
        f'no wlan {ssid_id}',
        f'wireless tag policy {location}',
        f'no wlan {ssid_id} policy Flexconnect-policy',
        f'end',
    ]
